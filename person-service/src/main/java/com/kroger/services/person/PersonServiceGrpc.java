...
public final class PersonServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.kroger.domains.person.PersonRequestOuterClass.PersonRequest,
      com.kroger.domains.person.PersonResponseOuterClass.PersonResponse> getFetchByIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "FetchById",
      requestType = com.kroger.domains.person.PersonRequestOuterClass.PersonRequest.class,
      responseType = com.kroger.domains.person.PersonResponseOuterClass.PersonResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.kroger.domains.person.PersonRequestOuterClass.PersonRequest,
      com.kroger.domains.person.PersonResponseOuterClass.PersonResponse> getFetchByIdMethod() {
    io.grpc.MethodDescriptor<com.kroger.domains.person.PersonRequestOuterClass.PersonRequest, com.kroger.domains.person.PersonResponseOuterClass.PersonResponse> getFetchByIdMethod;
      ...
      synchronized (PersonServiceGrpc.class) {
        if ((getFetchByIdMethod = PersonServiceGrpc.getFetchByIdMethod) == null) {
          PersonServiceGrpc.getFetchByIdMethod = getFetchByIdMethod =
              io.grpc.MethodDescriptor.<com.kroger.domains.person.PersonRequestOuterClass.PersonRequest, com.kroger.domains.person.PersonResponseOuterClass.PersonResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "FetchById"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kroger.domains.person.PersonRequestOuterClass.PersonRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.kroger.domains.person.PersonResponseOuterClass.PersonResponse.getDefaultInstance()))
  ...
  public static abstract class PersonServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void fetchById(com.kroger.domains.person.PersonRequestOuterClass.PersonRequest request,
        io.grpc.stub.StreamObserver<com.kroger.domains.person.PersonResponseOuterClass.PersonResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.kroger.domains.person.PersonRequestOuterClass.PersonRequest,
                com.kroger.domains.person.PersonResponseOuterClass.PersonResponse>(
  ...
  public static final class PersonServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PersonServiceBlockingStub> {
    ...
    /**
     */
    public com.kroger.domains.person.PersonResponseOuterClass.PersonResponse fetchById(com.kroger.domains.person.PersonRequestOuterClass.PersonRequest request) {
  ...
  public static final class PersonServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PersonServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.kroger.domains.person.PersonResponseOuterClass.PersonResponse> fetchById(
        com.kroger.domains.person.PersonRequestOuterClass.PersonRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FETCH_BY_ID:
          serviceImpl.fetchById((com.kroger.domains.person.PersonRequestOuterClass.PersonRequest) request,
              (io.grpc.stub.StreamObserver<com.kroger.domains.person.PersonResponseOuterClass.PersonResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class PersonServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.kroger.services.person.PersonServiceOuterClass.getDescriptor();
    }
